...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, MenuPage, TransferPage, TablaPage, WithdrawPage,DepositPage,InfoPage,About):
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tabla_button.place(x=900, y=30, width=300, height=100)
...
def register_user():
  ...
  if username_info in b:
    ...
    tel_entry.delete(0, END)
        ...
        label_num = Label(screen1, text = "Contraseña con por lo menos un numero    ",bg='#1e1e2d', fg='orange',font = ("Lucida Console", 11,'bold'))
        ...
        label_may = Label(screen1, text = "Contraseña con minimo una letra mayuscula",bg='#1e1e2d', fg='orange',font = ("Lucida Console", 11,'bold'))
