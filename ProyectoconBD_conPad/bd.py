...
class conectar:
     ...
     def transferencia_bd():
        ...
        cursor.execute("INSERT INTO estado_cuenta values ('"+rand+"', '"+fecha_alt+"', '"+str(curr2)+"', '"+id_cuenta_ban+"', '"+operaciones+"')")
        cursor.execute("INSERT INTO estado_cuenta values ('"+rand+"', '"+fecha_alt+"', '"+str(curr2)+"', '"+concepto+"', '"+concep+"')")
