...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#3AD57C')
        self.controller = controller
        self.controller.title('BANCO AMIGOS')
        self.controller.state('zoomed')
        self.controller.iconphoto(False,tk.PhotoImage(file='imagenes/abc.png'))
        space_label=tk.Label(self,height=6,bg='#3AD57C').pack()
        heading=tk.Label(self,text='Banco Amigos',font=('orbitron',45,'bold'),foreground='white',background='#3AD57C')
        heading.pack(pady=25)
        password_label=tk.Label(self,text=(f'BIENVENIDO {user_display_name}'),font=('BatmanForeverAlternate',20),bg='#3AD57C',fg='white').pack(pady=10)

        def next_page():
            controller.show_frame('MenuPage')

        entry_button = tk.Button(self,text='ACCEDER',fg='white', bg = "BLACK", width = "24", height = "3",font=("orbitron", 12,'bold'),command=next_page,relief='raised').pack(pady=10)
        ...
        quit1 = tk.Button(self,text='SALIR',fg='white', bg = "BLACK", width = "24", height = "3",font=("orbitron", 12,'bold'),command=popup,relief='raised').pack(pady=10)


        dualtone_label=tk.Label(self, text='',font=('orbitron',13),fg='white',bg='#3AD57C',anchor='n')
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading=tk.Label(self,text='CAJERO BANCO AMIGOS',font=('orbitron',45,'bold'),foreground='white',background='#3AD57C')
        heading.pack(pady=25)
        #main_menu_label=tk.Label(self,text='Main Menu',font=('orbitron',13),fg='white',bg='#3AD57C')
        #main_menu_label.pack(pady=5)
        slection_label=tk.Label(self,text='Selecciona una opción',font=('orbitron',25,'bold'),fg='white',bg='#3AD57C')
        slection_label.pack(fill='x',pady=5)

        button_frame=tk.Frame(self,bg='#3AD57C')
        ...
        info_button.grid(row=2,column=1,pady=5)
...
class TransferPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
            ...
            self.controller.title('BANCO AMIGOS')
            self.controller.state('zoomed')
            space_label=tk.Label(self,height=6,bg='white').pack()
            heading=tk.Label(self,text='TRANSFERENCIA BANCO AMIGOS',font=('orbitron',45,'bold'),foreground='white',background='black')
            heading.pack(pady=25)
            ...
            space_label=tk.Label(button_frame,height=2,bg='white')
            space_label.grid(row=2,column=1)

            enter_amount_label=tk.Label(button_frame,text='INGRESA LA CANTIDAD A TRANSFERIR',font=('orbitron',13),bg='black',fg='white')
            enter_amount_label.grid(row=1,column=1)

            deposito=tk.StringVar()
            deposito_entry=tk.Entry(button_frame,textvariable=deposito,font=('orbitron',12),width=22)
            deposito_entry.grid(row=1,column=2)

            enter_amount_label1=tk.Label(button_frame,text='INGRESA LA CUENTA A TRANSFERIR',font=('orbitron',13),bg='black',fg='white')
            enter_amount_label1.grid(row=3,column=1)

            transferencia=tk.StringVar()
            transferencia_entry=tk.Entry(button_frame,textvariable=transferencia,font=('orbitron',12),width=22)
            transferencia_entry.grid(row=3,column=2)
            ##transferencia_entry.pack(ipady=7)
            ...
            ##deposito_entry.bind('<Return>',popup)
            ...
            exit_button=tk.Button(button_frame,text='Menu',font=('orbitron',13),relief=RIDGE,borderwidth=3,width=23,height=4,command=exit)
...
class InfoPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        accid_info = tk.Label(upperframe, text=f'CORREO : {mail}', font=('orbitron',16),fg='white', bg='#33334d')
        accid_info.pack(pady=5)

        name_info = tk.Label(upperframe, text=f'NOMBRE : {ID_display}', font=('orbitron',16),fg='white', bg='#33334d')
        name_info.pack(pady=5)
...
def register():
  ...
  label = Label(screen1,image=img,bg='#3AD57C')
  label.image = img
  ...
  #Label(screen1, text = "Ingresa tus datos",bg='white',font = ("orbitron",20,'bold')).pack()

  #Label(screen1, text = "",bg='white').pack()

  Label(screen1, text = "Ingresa tu Nombre:",font = ("orbitron", 15),bg='#3AD57C').pack()
  name_entry = Entry(screen1,font = ("orbitron",18), textvariable = name,bg='white')
  name_entry.pack()

  Label(screen1, text = "Tu numero de cuenta es:",font = ("orbitron", 15),bg='#3AD57C').pack()
  rand=random.randint(1,100000)
  username=Label(screen1, text = rand,font = ("orbitron", 15),bg='yellow').pack()

  Label(screen1, text = "ingresa tu Apellido Paterno",font = ("orbitron", 15),bg='#3AD57C').pack()
  apellP_entry =  Entry(screen1,font = ("orbitron",18), textvariable = apellidoP,bg='white')
  apellP_entry.config(fg='black')
  apellP_entry.pack()

  Label(screen1, text = "Ingresa tu Apellido Materno",font = ("orbitron", 15),bg='#3AD57C').pack()
  apellM_entry =  Entry(screen1,font = ("orbitron",18), textvariable = apellidoM,bg='white')
  apellM_entry.config(fg='black')
  apellM_entry.pack()
  Label(screen1, text = "",bg='#3AD57C').pack()
  def generar():
        ...
        Label(screen1, text = Correo_info,bg='lightblue',font = ("orbitron", 10)).pack()
  
  button1= tk.Button(screen1,text = "Generar correo",fg='white', bg = "BLACK", width = "21", height = "2", font = ("orbitron", 12,'bold'),command=generar)
  button1.pack()

  Label(screen1, text = "Ingresa tu Telefono",font = ("orbitron", 15),bg='#3AD57C').pack()
  tel_entry =  Entry(screen1,font = ("orbitron",18), textvariable = telf,bg='white')
  tel_entry.config(fg='black')
  tel_entry.pack()

  #Label(screen1, text = "Ingresa tu Correo",font = ("orbitron", 15),bg='#3AD57C').pack()
  #correo_entry =  Entry(screen1,font = ("orbitron",18), textvariable = Correo,bg='white')
  #correo_entry.config(fg='black')
  #correo_entry.pack()

  Label(screen1, text = "Ingresa tu Contraseña",font = ("orbitron", 15),bg='#3AD57C').pack()
  ...
  label = Label(screen1,  text='Seleciona tu Posición', font= ("orbitron", 15), bg='#3AD57C').pack()

    # option menu
  option_menu = ttk.OptionMenu(screen1, option_var,languages[0],*languages).pack()


  Button(screen1,text = "REGISTRARSE",fg='white', bg = "BLACK", width = "21", height = "2", font = ("orbitron", 12,'bold'),command=register_user).pack(pady=5)
...
def login():
  ...
  Label(screen2, text = "Por favor ingresa tus datos para iniciar sesión",bg='white',font = ("orbitron", 25,'bold')).pack()
  ...
  Label(screen2, text = "Numero de cuenta",bg='white',font = ("orbitron", 15)).pack()
  username_entry1 = Entry(screen2,font = ("orbitron",15) ,textvariable = username_verify,bg='lightblue')
  username_entry1.pack()

  Label(screen2, text = "",bg='white').pack()
  Label(screen2, text = "Contraseña",bg='WHITE',font = ("orbitron", 15)).pack()
  password_entry1 = Entry(screen2,font = ("orbitron",15), textvariable = password_verify,bg='lightblue')
  password_entry1.config(fg='black',show='●')
  password_entry1.pack()
  Label(screen2, text = "",bg='white').pack()
  Button(screen2,text = "INICIAR SESIÓN",fg='white', bg = "BLACK", width = "22", height = "2", font = ("orbitron", 12,'bold'),command=login_verify).pack(pady=5)
...
def main_screen():
  ...
  Label(text = "",fg='white', bg = "#3AD57C", width = "300", height = "2", font = ("orbitron", 15,'bold')).pack()

  Label(text = "BANCO AMIGOS",fg='white', bg = "#3AD57C", width = "300", height = "2", font = ("orbitron", 35,'bold')).pack()
  Label(text = "", width = "300",bg='#3AD57C').pack()
  Label(text = "",fg='white', bg = "white", width = "300", height = "3", font = ("orbitron", 15,'bold')).pack()

  img = ImageTk.PhotoImage(Image.open("imagenes/banco.png"))
  panel = Label(screen, image = img,bg='white')
  panel.pack()

  Button(text = "INGRESAR",fg='white', bg = "BLACK", width = "21", height = "2", font = ("orbitron", 12,'bold'),command=login).pack(pady=5)
  Button(text = "REGISTRARSE",fg='white', bg = "BLACK", width = "21", height = "2", font = ("orbitron", 12,'bold'),command=register).pack(pady=5)
