...
class TransferPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading=tk.Label(self,text='Transferencia Banco Amigos',font=('orbitron',45,'bold'),foreground='white',background='#3d3d5c')
        heading.pack(pady=25)

        space_label=tk.Label(self,height=4,bg='#3d3d5c').pack()

        enter_amount_label=tk.Label(self,text='INGRESA LA CANTIDAD A TRANSFERIR',font=('orbitron',13),bg='#3d3d5c',fg='white').pack(pady=10)

        deposito=tk.StringVar()
        deposito_entry=tk.Entry(self,textvariable=deposito,font=('orbitron',12),width=22)
        deposito_entry.pack(ipady=7)

        enter_amount_label1=tk.Label(self,text='INGRESA LA CUENTA A TRANSFERIR',font=('orbitron',13),bg='#3d3d5c',fg='white').pack(pady=10)

        transferencia=tk.StringVar()
        transferencia_entry=tk.Entry(self,textvariable=transferencia,font=('orbitron',12),width=22)
...
def register_user():
  ...
  if username_info in b:
    ...
    tel_entry.delete(0, END)
        ...
        messagebox.showwarning('WARNING',('Ingresa una contraseña!'))
  elif telf_info=='' :
