...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        slection_label=tk.Label(self,text='Selecciona una opción',font=('orbitron',13),fg='white',bg='#3d3d5c')
        ...
        def transfer(_):
            ...
            try:
                ...
                if int(deposito.get())>current_balance:
                    ...
                    ##deposito.set('')
                    messagebox.showinfo('Realizando transferencia....')
                    ...
                    mycursor.execute("INSERT INTO estado_cuenta values ('"+rand+"', '"+fecha_alt+"', '"+current+"', '"+id_cuenta_ban+"', '"+operaciones+"')")
        ...
        def other_amount(_):
            ...
            try:
                ...
                if int(cash.get())>current_balance:
                    ...
                    mycursor.execute("INSERT INTO estado_cuenta values ('"+rand+"', '"+fecha_alt+"', '"+current_balance+"', '"+id_cuenta_ban+"', '"+operaciones+"')")
                    mydb.commit()
        ...
        def deposit_cash():
            ...
            try:
                ...
                if int(val)<0:
                    ...
                    sql = "SELECT TOP 1 id_cuenta_banc FROM cuenta_bancaria ORDER BY id_cuenta_banc DESC ;"
                    mycursor.execute(sql)
                    id_cuenta_ban = mycursor.fetchval()
                    id_cuenta_ban = str(id_cuenta_ban)
...
def register():
  ...
  Label(screen1, text = "Contraseña",font = ("orbitron", 10),bg='lightblue').pack()
  ...
  label = Label(screen1,  text='Seleciona tu Posición', font= ("orbitron", 10), bg='lightblue').pack()
  ...
  img1 = PhotoImage(file="imagenes/register_final.png")
...
def login():
  ...
  Label(screen2, text = "Por favor ingresa tus datos para iniciar sesión",bg='lightblue',font = ("orbitron", 10)).pack()
  ...
  img1 = PhotoImage(file="imagenes/login_final.png")
  photoimage1 = img1.subsample(3, 3)
...
def main_screen():
  ...
  Label(text = "",fg='white', bg = "grey", width = "300", height = "2", font = ("orbitron", 15,'bold')).pack()

  Label(text = "BANCO AMIGOS",fg='white', bg = "grey", width = "300", height = "2", font = ("orbitron", 25,'bold')).pack()
  Label(text = "", width = "300",bg='grey').pack()
  Label(text = "",fg='white', bg = "lightblue", width = "300", height = "3", font = ("orbitron", 15,'bold')).pack()

  img = ImageTk.PhotoImage(Image.open("imagenes/pr_logo.png"))
  panel = Label(screen, image = img,bg='lightblue')
  panel.pack()

  photo1 = PhotoImage(file="imagenes/login_final.png")
  ...
  photo2 = PhotoImage(file="imagenes/register_final.png")
