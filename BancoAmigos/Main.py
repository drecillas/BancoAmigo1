...
class TablaPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        upperframe=tk.Frame(self,bg='#1e1e2d')
        upperframe.pack(fill='both',expand='True')
        name_info =tk.Label(upperframe, text= f'{user_display_name} {apep_display_name} {apem_display_name}',font=('orbitron',20,'bold'),fg='yellow',bg='#1e1e2d').pack(pady=5)
        button_frame=tk.Frame(self,bg='#1e1e2d')
        ...
        exit_button=tk.Button(button_frame,text='Regresar al Menu',command=quit,font=('orbitron',13),relief=RIDGE,borderwidth=3,width=20,height=2)
