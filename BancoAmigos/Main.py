...
class TransferPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            enter_button=tk.Button(self,text='Enter',font=('Lucida Console',13),command=transfer,relief='raised',borderwidth=3,width=23,height=3)
            enter_button.place(x=720, y=380)
...
################################
        ...
        enter_button=tk.Button(self,text='Enter',font=('Lucida Console',13),command=other_amount,relief='raised',borderwidth=3,width=23,height=3)
        enter_button.place(x=1140, y= 540)
    def on_balance_changed(self, *args):
        self.balance_var.set('Saldo Actual: $'+str(self.controller.shared_data['Balance'].get()))
