    ...
    def __init__(self, parent, controller):
        ...
        def delete():
            for item in tabla.get_children():
                tabla.delete(item)
        actualizar_button=tk.Button(button_frame,text='Actualizar',command=listar,font=('Lucida Console',13),relief=RIDGE,borderwidth=3,width=20,height=2)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        cash=tk.StringVar()
        other_amount_entry=tk.Entry(button_frame,font=('Lucida Console',12),textvariable=cash,width=28,justify='right')
