...
class TransferPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            enter_button=tk.Button(self,text='Transferir',font=('Lucida Console',13),command=transfer,relief='raised',borderwidth=3,width=23,height=3)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        enter_button=tk.Button(self,text='Retirar',font=('Lucida Console',13),command=other_amount,width=23,height=3)
...
def register_user():
  ...
  if username_info in b:
    label = Label(screen1, text = "El Usuario ingresado ya existe  ",bg='#1e1e2d', fg='orange',font = ("Lucida Console", 11,'bold'))
    label.place(x= 720, y=520)
    name_entry.delete(0,END)

  elif telf_info in a:
    label = Label(screen1, text = "El telefono ingresado ya existe",bg='#1e1e2d', fg='orange',font = ("Lucida Console", 11,'bold'))
    label.place(x= 720, y=520)
