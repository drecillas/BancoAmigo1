...
class TablaPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ##labelframe3=ttk.LabelFrame(self, text="Artículo")
        ...
        def listar():
            ...
            for respuesta in respuestas:
                ...
                ##tabla.insert('','',text=fecha_est_cuenta,values=(folio,fecha,saldo,operacion))
