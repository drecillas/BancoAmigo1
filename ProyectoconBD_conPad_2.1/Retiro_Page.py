...
class WithdrawPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        controller.shared_data['Balance'].set(float(var.current_balance))
        ...
        def other_amount(self):
            ...
            try:
                var.val=float(cash.get())
                if float(cash.get())>var.current_balance:
                    messagebox.showwarning('ATENCIÓN','SALDO INSUFICIENTE!')
                    other_amount_entry.delete(0,END)
                elif float(cash.get())<0:
                    ...
                    if r=='yes':
                        var.current_balance -= float(cash.get())
        ...
        Button(self, text="1",width=5,height=2,command=lambda:btnClik(1)).place(x=580,y=250)
        Button(self, text="2",width=5,height=2,command=lambda:btnClik(2)).place(x=640,y=250)
        Button(self, text="3",width=5,height=2,command=lambda:btnClik(3)).place(x=700,y=250)
        
        Button(self, text="4",width=5,height=2,command=lambda:btnClik(4)).place(x=580,y=300)
        Button(self, text="5",width=5,height=2,command=lambda:btnClik(5)).place(x=640,y=300)
        Button(self, text="6",width=5,height=2,command=lambda:btnClik(6)).place(x=700,y=300)

        Button(self, text="7",width=5,height=2,command=lambda:btnClik(7)).place(x=580,y=350)
        Button(self, text="8",width=5,height=2,command=lambda:btnClik(8)).place(x=640,y=350)
        Button(self, text="9",width=5,height=2,command=lambda:btnClik(9)).place(x=700,y=350)

        Button(self, text="0",width=5,height=2,command=lambda:btnClik(0)).place(x=640,y=400)
        Button(self, text=".",width=5,height=2,command=lambda:btnClik(".")).place(x=700,y=400)
        Button(self, text="C",width=5,height=2,command=clear).place(x=580,y=400)
        Button(self, text="Enter",width=5,height=2,command=lambda:(other_amount(self),clear())).place(x=640,y=450)
