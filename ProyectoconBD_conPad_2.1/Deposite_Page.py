...
class DepositPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        peso.place(x=455, y=327, height=40)
        cash=tk.StringVar()
        deposit_entry=tk.Entry(self,textvariable=cash,font=('Lucida Console',20,'bold'),width=22,justify="left")
        ...
        Button(self, text="1",width=5,height=2,command=lambda:btnClik(1)).place(x=900,y=280)
        Button(self, text="2",width=5,height=2,command=lambda:btnClik(2)).place(x=950,y=280)
        Button(self, text="3",width=5,height=2,command=lambda:btnClik(3)).place(x=1000,y=280)
        
        Button(self, text="4",width=5,height=2,command=lambda:btnClik(4)).place(x=900,y=330)
        Button(self, text="5",width=5,height=2,command=lambda:btnClik(5)).place(x=950,y=330)
        Button(self, text="6",width=5,height=2,command=lambda:btnClik(6)).place(x=1000,y=330)

        Button(self, text="7",width=5,height=2,command=lambda:btnClik(7)).place(x=900,y=380)
        Button(self, text="8",width=5,height=2,command=lambda:btnClik(8)).place(x=950,y=380)
        Button(self, text="9",width=5,height=2,command=lambda:btnClik(9)).place(x=1000,y=380)

        Button(self, text="0",width=5,height=2,command=lambda:btnClik(0)).place(x=900,y=430)
        Button(self, text="C",width=5,height=2,command=clear).place(x=950,y=430)
        Button(self, text="Enter",width=5,height=2,command=lambda:(deposit_cash(self),clear())).place(x=1000,y=430)
