...
class TransferPage(tk.Frame):
        def __init__(self, parent, controller):
            ...
            Button(self, text=".",width=5,height=2,command=lambda:btnClik(".")).place(x=1060,y=430)
            ...
            Button(self, text="Enter",width=5,height=2,command=lambda:(transfer(self),clear())).place(x=1000,y=480)
