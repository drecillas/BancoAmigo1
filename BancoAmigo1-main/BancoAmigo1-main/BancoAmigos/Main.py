...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tabla_button=tk.Button(button_frame,text='ESTADO DE CUENTA',font=('orbitron',13),command=lambda:[lista(),listar()],relief='raised',borderwidth=3,width=30,height=4)
...
class TablaPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tabla=ttk.Treeview(button_frame,columns=("#0","#1","#2","#3"))
        tabla.grid(row=4,column=1,columnspan=3)
        ...
        boton2=ttk.Button(button_frame, text="Regresar", command=lambda:[delete(),quit()])
        boton2.grid(column=2, row=1, padx=4, pady=4)

        boton1=ttk.Button(button_frame, text="Listado completo", command=listar)
