...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        withdraw_button.place(x=100, y=30, width=300, height=100)
        ...
        deposit_button.place(x=100, y=150, width=300, height=100)
        def balance():
            controller.show_frame('BalancePage')

        balance_button=tk.Button(button_frame,text='SALDO',font=('Lucida Console',13),command=balance,relief='raised',borderwidth=3,width=30,height=4)
        balance_button.place(x=900, y=30, width=300, height=100)
        ...
        info_button.place(x=900, y=150, width=300, height=100)
        ...
        tabla_button.place(x=100, y=390, width=300, height=100)
        ...
        trasf_button.place(x=100, y=270, width=300, height=100)
        ...
        trasf_button.place(x=900, y=270, width=300, height=100)
        ...
        exit_button.place(x=900, y=390, width=300, height=100)
...
class TransferPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            ns=tk.Label(self,text="SALDO ACTUAL :$",font=('Lucida Console',15,'bold'),foreground='yellow',background='#1e1e2d')
            ns.place(x=530, y=185, height=30)

            bal=tk.Label(self,text=current_balance,font=('Lucida Console',15,'bold'),foreground='yellow',background='#1e1e2d')
            bal.place(x=730, y=185, height=30)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ns=tk.Label(self,text="SALDO ACTUAL :$",font=('Lucida Console',15,'bold'),foreground='yellow',background='#1e1e2d')
        ns.place(x=530, y=155, height=30)

        bal=tk.Label(self,text=current_balance,font=('Lucida Console',15,'bold'),foreground='yellow',background='#1e1e2d')
        bal.place(x=730, y=155, height=30)
       ...
       # other_amount_heading.grid(row=3,column=1)
...
def register_user():
  ...
  if username_info in b:
    ...
    tel_entry.delete(0, END)
        ...
        messagebox.showwarning('ALERTA',('Ingresa un nombre!'))
        password_entry.delete(0,END)
        screen1.destroy()
  elif password_info=='':
        messagebox.showwarning('ALERTA',('INGRESE UNA CONTRASEÑA VALIDA'))
        screen1.destroy()
  elif len(password_info)<=8 :
        messagebox.showwarning('ALERTA',('INGRESE UNA CONTRASEÑA CON MAS DE 8 CARACTERES'))
        screen1.destroy()
        ...
        messagebox.showwarning('ALERTA',('Ingresa un telefono valido!'))
        password_entry.delete(0,END)
  elif apellidoP_info=='' :
        messagebox.showwarning('ALERTA',('Ingresa apellido paterno!'))
  elif apellidoM_info=='' :
        messagebox.showwarning('ALERTA',('Ingresa apellido materno!'))
        password_entry.delete(0,END)
  elif Correo_info=='' :
        messagebox.showwarning('ALERTA',('Ingresa un correo!'))
  else:
